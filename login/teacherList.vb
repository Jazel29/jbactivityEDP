...
Public Class teacherList
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Dim strsql As String = "INSERT INTO teachers VALUES('" & Me.txtID.Text & "','" & Me.txtName.Text & "','" & Me.txtEmail.Text & "','" & Me.txtDepartment.Text & "','" & Me.txtOffice.Text & "' )"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Dim strsql As String = "UPDATE teachers SET name = '" & Me.txtName.Text & "', email = '" & Me.txtEmail.Text & "', department = '" & Me.txtDepartment.Text & "', office = '" & Me.txtOffice.Text & "' WHERE id = " & Me.txtID.Text
        Connect_to_DB()
        Dim myCommand As New MySqlCommand
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Dim strsql As String = "delete from teachers where id = '" & Me.txtID.Text & "'"
    ...
    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        ...
        Dim DBConnectionString As String = "server=localhost;user id=root; port=3306; password=admin; database=activity"
        Dim strsql As String = "SELECT * FROM teachers"
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        Dim DBConnectionString As String = "server=localhost;user id=root; port=3306; password=admin; database=activity"
        Dim strsql As String = "SELECT * FROM teachers WHERE name LIKE '%" & nameToSearch & "%'"
        Dim dt As New DataTable()
    ...
    Private Sub btnBackup_Click(sender As Object, e As EventArgs) Handles btnBackup.Click
        Try
            If Not String.IsNullOrEmpty(csvFilePath) Then
                ...
                Dim backupFilePath As String = Path.Combine(Path.GetDirectoryName(csvFilePath), "teacherBackup.bat")
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            exlFile.Workbooks.Open("C:\Users\Mark Louie Manrique\source\repos\login\template\teacherTemplate.xlsx")
            ...
            Dim filename As String = "teacherRecord_" & DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") & ".xlsx"
